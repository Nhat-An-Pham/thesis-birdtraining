  ...
  const [reportList, setReportList] = useState([]);
    ...
    const fetchReportData = async () => {
        try {
          ...
          const response = await fetch(`http://13.214.85.41/api/trainingcourse-staff/birdtrainingreport-progressid?progressId=${progressId}`);
  ...
  return (
    <div>
        ...
        <div className="main-button-container">
          <button className="button" onClick={() => handleCallBackSkillButton()}>Back</button>
        </div>
