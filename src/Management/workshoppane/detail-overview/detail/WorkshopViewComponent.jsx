import { Checkbox, CircularProgress, Grid, ImageList, ImageListItem, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from "@mui/material";
import { useEffect, useState } from "react";
import { getWorkshops, switchWorkshopStatus } from "../../workshopService";
...
export default function WorkshopViewComponent({workshopId}) {
    ...
    const switchStatus = async (workshop) => {
      try {
        let result = await switchWorkshopStatus(workshop);
        if(result){
