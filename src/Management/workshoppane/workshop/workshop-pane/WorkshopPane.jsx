...
import { Table, TableContainer, TableHead, TableBody, TableCell, TableRow, Paper, Checkbox, Alert, Grid, CircularProgress, Drawer } from '@mui/material';
...
const WorkshopPane = ({callbackSelectWorkshop, statusFilter = 'Active', onRowClick}) => {    
